		...
		@$page=  $_GET['page'];
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
              <li><a href="#"><img src="../images/welcome.gif" width="200" height="200" alt="not found"/></a></li>
              <br>
              <span class="text-muted">Welcome</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
             <li><a href="https://www.twitter.com"><img src="../images/twitter.png" width="200" height="200" alt="not found"/></a></li>
              <br>
              <span class="text-muted">Twitter</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <li><a href="https://www.facebook.com"><img src="../images/facebook.png" width="200" height="200" alt="not found"/></a></li>
              <br>
              <span class="text-muted">Facebook</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
              <li><a href="https://mail.google.com/mail"><img src="../images/gmail.png" width="200" height="200" alt="not found"/></a></li>
              <br>
